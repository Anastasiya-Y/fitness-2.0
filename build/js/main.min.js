...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _initSwiper.initSwiperTrainers)();
    form.init();
  });
});
...
},{"./modules/form-validate/form":3,"./modules/init-swiper":9,"./modules/init-video":10,"./modules/modals/init-modals":11,"./modules/tabs/init-tabs":13,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";
...
exports.initSwiperTrainers = void 0;
var swiperContainerTrainers = document.querySelector('.trainers__container');
var initSwiperTrainers = function initSwiperTrainers() {
  var swiper = new Swiper(swiperContainerTrainers, {
    navigation: {
...
exports.initSwiperTrainers = initSwiperTrainers;
...
var videoGym = document.querySelector('.gym__video-wrapper');
var videoGymLink = videoGym.querySelector('.gym__video-link');
var videoGymButton = videoGym.querySelector('.gym__video-button');
function createUrl() {
  var regexp = /https:\/\/www\.youtube\.com\/watch\?v=([a-zA-Z0-9_-]+)/i;
  var linkUrl = videoGymLink.getAttribute('href');
  var match = linkUrl.match(regexp);
  return match[1];
}
var videoId = createUrl();
...
var initVideo = function initVideo() {
  videoGym.addEventListener('click', function () {
    var iframeUser = createIframe();
    videoGymLink.remove();
